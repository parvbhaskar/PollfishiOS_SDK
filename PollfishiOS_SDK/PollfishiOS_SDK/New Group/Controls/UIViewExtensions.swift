...
extension UIView
{
    ...
    func safeAnchorConstraints(with view: UIView) -> Dictionary<ConstraintType, NSLayoutConstraint>
    {
        var ret = Dictionary<ConstraintType, NSLayoutConstraint>()
        
        ret[.left] = safeAreaLayoutGuide.leftAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leftAnchor)
        
        
        ret[.top] = safeAreaLayoutGuide.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor)
        
        
        ret[.right] = safeAreaLayoutGuide.rightAnchor.constraint(equalTo: view.safeAreaLayoutGuide.rightAnchor)
        
        
        ret[.bottom] = safeAreaLayoutGuide.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor)
    ...
    func safeAnchorConstraints(
            ...
            centerY: NSLayoutYAxisAnchor? = nil) -> Dictionary<ConstraintType, NSLayoutConstraint>
    {
        var ret = Dictionary<ConstraintType, NSLayoutConstraint>()
        ...
        if let centerY = centerY
        {
            ret[.centerY] = safeAreaLayoutGuide.centerYAnchor.constraint(equalTo: centerY, constant: bottomConstant)
        }
    ...
    func sizeConstraints(
            ...
            width: NSLayoutDimension? = nil) -> Dictionary<ConstraintType, NSLayoutConstraint>
    {
        var ret = Dictionary<ConstraintType, NSLayoutConstraint>()

        if let height = height
        {
            ret[.height] = heightAnchor.constraint(equalTo: height)
        }

        if let width = width
        {
            ret[.width] = widthAnchor.constraint(equalTo: width)
        }
